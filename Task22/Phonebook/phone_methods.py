...
def delete(quest_answear, search_delete):
    while True:
        with open("phone_book.json", "r+") as jsonbook:
            jsonbookserializ = json.load(jsonbook)
